          ...
          <div key={collaborator.id}>
            ...
            <div className="mt-4 flex justify-center gap-x-4">
              {collaborator.twitter && (
                <Link href={collaborator.twitter} target="_blank" className="text-muted-foreground hover:text-foreground">
                  <span className="sr-only">Twitter</span>
                  <Twitter className="h-5 w-5" />
                </Link>
              )}
              {collaborator.linkedin && (
                <Link href={collaborator.linkedin} target="_blank" className="text-muted-foreground hover:text-foreground">
                  <span className="sr-only">LinkedIn</span>
                  <Linkedin className="h-5 w-5" />
                </Link>
              )}
              {collaborator.github && (
                <Link href={collaborator.github} target="_blank" className="text-muted-foreground hover:text-foreground">
